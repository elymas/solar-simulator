...
// on enter/exit), so the solar view keeps DEGRADE_STEPS unchanged. No 'belts' step
// here — the belts live in the solar scene, which the Earth view does not render.
